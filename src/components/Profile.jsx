      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="md:pl-6">
          ...
          <p className="text-base md:text-lg leading-relaxed text-gray-700 mb-8 max-w-xl">
            ...
            <span className="font-semibold"> P.W. Kamotho & Co. Advocates</span>, 
          ...
          <button className="px-6 py-3 bg-teal-800 text-white font-medium rounded-full shadow-md hover:bg-indigo-900 transition">
            Learn More
          </button>
        </div>
      </div>
