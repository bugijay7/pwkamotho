...
function Services() {
  const areas = [
    ...
    {
      icon: <FaFileSignature className="text-4xl text-teal-800" />,
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h2 className="text-3xl font-bold text-teal-800">Our Practice Areas</h2>
      ...
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
        {areas.map((area, index) => (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-teal-800 mb-2">{area.title}</h3>
